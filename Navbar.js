...
const Navbar = () => {
  return (
    <nav className="w-full fixed h-20 bg-white shadow-md flex justify-between items-center z-30">
      ...
      <ul className="flex gap-8 text-xl font-medium mr-4">
        ...
        <a href="/FAQ" className="font-medium text-xl px-4 py-2 rounded-md text-black hover:text-gray-600 list-style-none">
          FAQs
        </a>
